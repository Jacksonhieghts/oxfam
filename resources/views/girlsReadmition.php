...
font-size: 16px;"> Last access : 17 Jan 2018 &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                   ...
                   <a href="<?php echo url('training') ?>"><i class="fa fa-edit fa-3x"></i> Training Monitoring form</a>
                    ...
                    <li>
                    <a class="active-menu"  href="<?php echo url('girlsReadmition') ?>"><i class="fa fa-edit fa-3x"></i>Girl Readmission Form</a>
                    </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h3>GIRLS READMITTION AND SUPPORTED </h3>
                 ...
                 <!-- /. ROW  -->
                 <hr />
<form action="/insertgirlsReadmition" method ="post">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                                ...
                                <table class="table">
                                    ...
                                    <td><input type="text" name="term" maxlength="30"  size="40" />
                                    
                                    </td>
                                    </tr>                                     
                                    <tr>
                                    <td align="left">Girls re-admitted in school :</td>
                                    <td><input type="text" name="GirlsReadmin" maxlength="30" size="40"/>
                                    
                                    </td>
                                    </tr>
                                    <tr>
                                    <td align="left" border-radius:25>Girls under open /Night:</td>
                                    <td>
                                    <input type="text" name="GirlsAdminNight" maxlength="10" size="7"/>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td align="left">girls under day:</td>
                                    <td>
                                    <input type="text" name="GirlsAdminDay" maxlength="10" size="7"/>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td align="left">girls under project bursary.:</td>
                                    <td>
                                    <input type="text" name="GirlsBursary" maxlength="10" size="10"/>
                                    </td>
                                    </tr>                                                           
                                    <tr>
                                    <td align="left">girls supported with other school materials:</td>
                                    <td>
                                    <input type="text" name="SchoolMaterials" maxlength="10" size="18"/>
